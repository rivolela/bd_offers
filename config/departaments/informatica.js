module.exports = {
	...
	array : [
    	...
    	{
    		query : "notebook", 
    	dictionary: 'merchantcategory=' + 'Informática / Notebooks e Conversíveis / Notebooks' + '&' +
    	...
    	{query : "multifuncionais", 
    	dictionary: 'merchantcategory=' + 'Informática' + '&' +
    	...
    	{query : "navegador GPS", 
    	dictionary: 'merchantcategory=' + 'Automotivo / GPS e Acessórios / GPS' + '&' +
