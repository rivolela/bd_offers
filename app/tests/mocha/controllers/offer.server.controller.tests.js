...
describe('Offer Unit Tests:',function(done){
	...
	describe('Testing reviews conter in offer controller >>',function(){
		...
		it('Should add total of reviews = 5, total of countSad = 3 and total of countHappy = 5 from ean(77777777777777) >>',function(done){
			...
			offerController.setReviewsCounterOffer(Context.arrayOffers[0],function(offer){
		...
		it('Should save offer in bd with reviews >>',function(done){
			offerController.saveOfferWithReviews(Context.arrayOffers[0],function(error){
	...
	describe('Testing save product by offer',function(){
		it('should not return error in save product by offer',function(done){
			this.timeout(20000);
			offerController.saveProductsOffersArray(Context.currentItem,Context.arrayOffers,function(error){
				should.not.exist(error);
				done();
			});
		});
